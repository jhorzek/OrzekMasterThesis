#' Simulation study 3
#' 50 percent of cross-lagged parameters non-zero
#'
#'
...
#'
#'
simulation3_50 <- function(sampleSize, seed, wd, total_repetitions, crossEffect, autoEffect){
  setwd(wd)
  ##### Settings #####
  ...
  while(iteration <= total_repetitions){
    ...
    # simulate ARCL-SEM:
    simObj <- simARCL_scaled_50(sampleSize = sampleSize, autoEffect = autoEffect, crossEffect = crossEffect)
  ...
  save(overall_evaluation, parameterValues, RMSE, total_repetitions, Avalues, penAelement, Svalues, error, seed, crossEffect, autoEffect, file = paste("Simulation3_N", sampleSize, "_50percent_1_1000.RData", sep = ""))
