...
#'
#'
#' simARCL_scaled_20 creates an ARCL(1)-SEM model with OpenMx with 5 latent variables and 1 manifest per latent and time point for data simulation. It returns the simulated data set and a covariance based and a raw data based model. 10 Timepoints are created of which the initial five are omitted (burned)
#' The model has 20% non-zero cross-lagged effects
#'
#'
#' @author Jannik Orzek
#' @import OpenMx
...
#t2
  ...
  x2_t2 <- autoEffect*x2_t1 + crossEffect*x3_t1 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t1) + crossEffect^2*var(x3_t1)+ autoEffect*crossEffect*2*cov(x2_t1,x3_t1))))
  ...
  x4_t2 <- autoEffect*x4_t1 + crossEffect*x5_t1 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t1) + crossEffect^2*var(x5_t1)+ autoEffect*crossEffect*2*cov(x4_t1,x5_t1))))
  x5_t2 <- autoEffect*x5_t1 + crossEffect*x1_t1 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t1) + crossEffect^2*var(x1_t1)+ autoEffect*crossEffect*2*cov(x5_t1,x1_t1))))
#t3
  ...
  x2_t3 <- autoEffect*x2_t2 + crossEffect*x3_t2 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t2) + crossEffect^2*var(x3_t2)+ autoEffect*crossEffect*2*cov(x2_t2,x3_t2))))
  ...
  x4_t3 <- autoEffect*x4_t2 + crossEffect*x5_t2 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t2) + crossEffect^2*var(x5_t2)+ autoEffect*crossEffect*2*cov(x4_t2,x5_t2))))
  x5_t3 <- autoEffect*x5_t2 + crossEffect*x1_t2 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t2) + crossEffect^2*var(x1_t2)+ autoEffect*crossEffect*2*cov(x5_t2,x1_t2))))
  ...
  x2_t4 <- autoEffect*x2_t3 + crossEffect*x3_t3 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t3) + crossEffect^2*var(x3_t3)+ autoEffect*crossEffect*2*cov(x2_t3,x3_t3))))
  ...
  x4_t4 <- autoEffect*x4_t3 + crossEffect*x5_t3 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t3) + crossEffect^2*var(x5_t3)+ autoEffect*crossEffect*2*cov(x4_t3,x5_t3))))
  x5_t4 <- autoEffect*x5_t3 + crossEffect*x1_t3 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t3) + crossEffect^2*var(x1_t3)+ autoEffect*crossEffect*2*cov(x5_t3,x1_t3))))
  ...
  x2_t5 <- autoEffect*x2_t4 + crossEffect*x3_t4 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t4) + crossEffect^2*var(x3_t4)+ autoEffect*crossEffect*2*cov(x2_t4,x3_t4))))
  ...
  x4_t5 <- autoEffect*x4_t4 + crossEffect*x5_t4 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t4) + crossEffect^2*var(x5_t4)+ autoEffect*crossEffect*2*cov(x4_t4,x5_t4))))
  x5_t5 <- autoEffect*x5_t4 + crossEffect*x1_t4 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t4) + crossEffect^2*var(x1_t4)+ autoEffect*crossEffect*2*cov(x5_t4,x1_t4))))
  ...
  x2_t6 <- autoEffect*x2_t5 + crossEffect*x3_t5 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t5) + crossEffect^2*var(x3_t5)+ autoEffect*crossEffect*2*cov(x2_t5,x3_t5))))
  ...
  x4_t6 <- autoEffect*x4_t5 + crossEffect*x5_t5 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t5) + crossEffect^2*var(x5_t5)+ autoEffect*crossEffect*2*cov(x4_t5,x5_t5))))
  x5_t6 <- autoEffect*x5_t5 + crossEffect*x1_t5 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t5) + crossEffect^2*var(x1_t5)+ autoEffect*crossEffect*2*cov(x5_t5,x1_t5))))
  ...
  x2_t7 <- autoEffect*x2_t6 + crossEffect*x3_t6 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t6) + crossEffect^2*var(x3_t6)+ autoEffect*crossEffect*2*cov(x2_t6,x3_t6))))
  ...
  x4_t7 <- autoEffect*x4_t6 + crossEffect*x5_t6 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t6) + crossEffect^2*var(x5_t6)+ autoEffect*crossEffect*2*cov(x4_t6,x5_t6))))
  x5_t7 <- autoEffect*x5_t6 + crossEffect*x1_t6 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t6) + crossEffect^2*var(x1_t6)+ autoEffect*crossEffect*2*cov(x5_t6,x1_t6))))
  ...
  x2_t8 <- autoEffect*x2_t7 + crossEffect*x3_t7 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t7) + crossEffect^2*var(x3_t7)+ autoEffect*crossEffect*2*cov(x2_t7,x3_t7))))
  ...
  x4_t8 <- autoEffect*x4_t7 + crossEffect*x5_t7 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t7) + crossEffect^2*var(x5_t7)+ autoEffect*crossEffect*2*cov(x4_t7,x5_t7))))
  x5_t8 <- autoEffect*x5_t7 + crossEffect*x1_t7 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x5_t7) + crossEffect^2*var(x1_t7)+ autoEffect*crossEffect*2*cov(x5_t7,x1_t7))))
  ...
  x2_t9 <- autoEffect*x2_t8 + crossEffect*x3_t8 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x2_t8) + crossEffect^2*var(x3_t8)+ autoEffect*crossEffect*2*cov(x2_t8,x3_t8))))
  ...
  x4_t9 <- autoEffect*x4_t8 + crossEffect*x5_t8 + rnorm(n = sampleSize, 0, sd = sqrt(1-(autoEffect^2*var(x4_t8) + crossEffect^2*var(x5_t8)+ autoEffect*crossEffect*2*cov(x4_t8,x5_t8))))
